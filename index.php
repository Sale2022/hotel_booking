    ...
    <div class="container">
       ...
       <img class="img-responsive" src="images/logo1.png" style="width:100%; height:180px;">      
        ...
        <div class="row" style="color: #ed9e21">
            <div class="col-sm-3">
                <div class="well">
                    <h4><strong style="color: #ffbb2b">Contact Us</strong></h4><hr>
                    <p>Address : <br> Bismarckstr. 71 <br> 10115 Berlin <br> Deutschland</p><br> 
                    <p>E-mail : hotelshilton@gmail.com <br> Telephone : +49 31 132 321 34</p>
                </div>
            </div>
