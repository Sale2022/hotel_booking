...
<body>
    <div class="container">
       ...
       <img class="img-responsive" src="images/logo1.png" style="width:100%; height:180px;">      
        ...
        $sql="SELECT * FROM hotels, bookings, customers WHERE booked='true'";
                ...
                while($row = mysqli_fetch_array($result))
                {
                    ...
                    echo "
                            ...
                            <div class='col-md-6 well'>
                                ...
                                <h6>Payed: ".$row['payment']."</h6>
                            </div>
                            &nbsp;&nbsp;
                            <a href='edit_all_room.php?id=".$row['roomname']."'><button class='btn btn-primary button'>Edit</button></a>
                            </div>
