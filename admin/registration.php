        ...
        <div class="well">
            ...
            <form action="" method="post" name="reg">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="fullname" placeholder="example: Max Musterman" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" name="uemail" placeholder="example: maxmusterman@gmail.com" required>
                </div>
                <div class="form-group">
